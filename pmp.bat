...
set PMP_RUNNER_X64SC_OPTIONS=+confirmonexit +saveres -jamaction 2 -drive8type 1541 -drive9type 1541 -9 ".\fd.d64" -moncommands .\boot\target\boot.vice-labels -moncommands .\sh\target\sh.vice-labels -moncommands %VICE_LIB%\c64-kernal-r3-serial.vice-labels
