...
Redirect output from a command to the printer  with '>>'. Printer device is 4, secondary address is 7, which is the business mode with lower and upper case characters:
